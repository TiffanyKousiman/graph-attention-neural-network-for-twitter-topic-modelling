...
def main(args):
    ...
    log_file_path = f'./results/{args.num_topics}_{args.num_epoch}_{args.trans_induc}_{args.degree}_{args.num_hop}_{args.doc_sim_metric}_{args.adj_cut_off}_log.txt'
